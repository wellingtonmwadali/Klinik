...
// Route path preserved verbatim from the pre-existing app/(app)/patients/appointment.tsx/
// directory; only the duplicated doctors-list content/component name was fixed here.
